...
$sentSuccessfully = count(array_filter($details, function($d) { return $d['status'] === 'sent'; }));
$sentFailed = count(array_filter($details, function($d) { return $d['status'] === 'failed'; }));
$pending = count(array_filter($details, function($d) { return $d['status'] === 'pending'; }));
